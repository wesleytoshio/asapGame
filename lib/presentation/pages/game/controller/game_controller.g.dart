...
mixin _$GameController on _GameControllerBase, Store {
  ...
  @override
  dynamic startTimeLeft({int duration = 20}) {
  ...
  @override
  dynamic stopwatchPlayers({int duration = 5}) {
    final _$actionInfo = _$_GameControllerBaseActionController.startAction(
        name: '_GameControllerBase.stopwatchPlayers');
    try {
      return super.stopwatchPlayers(duration: duration);
    } finally {
      _$_GameControllerBaseActionController.endAction(_$actionInfo);
    }
  }
